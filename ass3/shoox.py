...
# Load dataset
iris_df = pd.read_csv('../Assignment_3/iris.csv')
...
X = iris_df[['sepal.length', 'sepal.width', 'petal.length', 'petal.width']].values #2d list
y = iris_df['variety'].values  #vector ,1d list
